...
public:
    ...
    bool is_open( ) const;
    void on_mouse_hover( int pixel_x, int pixel_y, presenters::BattlePresenter& presenter );
    void process_events( presenters::BattlePresenter& presenter );
    void render( );
    ...
    void
    set_hover_destination_highlight( int q, int r, bool has_tail, int tail_q, int tail_r ) override;
    ...
    void
    queue_attack_animation_facing( std::uint64_t attacker_id, int target_q, int target_r ) override;
    void queue_projectile_animation( std::uint64_t attacker_id,
                                     int target_q,
                                     int target_r,
...
private:
    ...
    void handle_corpse_state_transition( const UnitRenderData& unit,
    ...
    bool route_action_click( float x, float y, presenters::BattlePresenter& presenter );
