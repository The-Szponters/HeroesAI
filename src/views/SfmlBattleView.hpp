...
public:
    ...
    // Temporary diagnostic: bypasses MVP, loads one DEF and shows it raw.
    // Call at the END of the constructor to run before the game loop.
    // Press Escape to exit the debug view and continue, or close the window.
    void debug_render_sanity_check();
...
private:
    ...
    void process_visual_event_update();
